...
def load_tf_weights(model, resolved_archive_file, ignore_mismatched_sizes=..., _prefix=...): # -> tuple[list[str | Any], list[Any], list[Any]] | tuple[list[Any], list[Any], list[Any]]:
    """
    Detect missing and unexpected layers and load the TF weights from the shard file accordingly to their names and
    shapes.
