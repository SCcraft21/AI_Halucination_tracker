...
class FlaxT5Block(nn.Module):
    ...
    def __call__(self, hidden_states, attention_mask=..., position_bias=..., encoder_hidden_states=..., encoder_attention_mask=..., encoder_decoder_position_bias=..., output_attentions=..., return_dict=..., deterministic=..., init_cache=...): # -> tuple[Any | tuple[Any, Any, Any] | tuple[Any, Any], *tuple[Any, ...]] | tuple[Any | tuple[Any, Any, Any] | tuple[Any, Any], Any, Any] | tuple[Any | tuple[Any, Any, Any] | tuple[Any, Any], Any]:
        ...
...
class FlaxT5LayerCollection(nn.Module):
    ...
    def __call__(self, hidden_states, attention_mask=..., position_bias=..., encoder_hidden_states=..., encoder_attention_mask=..., encoder_decoder_position_bias=..., output_attentions=..., deterministic=..., init_cache=...): # -> tuple[Any | tuple[Any, Any, Any] | tuple[Any, Any], *tuple[Any, ...]] | tuple[Any | tuple[Any, Any, Any] | tuple[Any, Any], Any, Any] | tuple[Any | tuple[Any, Any, Any] | tuple[Any, Any], Any]:
        ...
