...
class TFBlenderbotDecoder(keras.layers.Layer):
    ...
    @unpack_inputs
    def call(self, input_ids=..., inputs_embeds=..., attention_mask=..., position_ids=..., encoder_hidden_states=..., encoder_attention_mask=..., head_mask=..., cross_attn_head_mask=..., past_key_values=..., use_cache=..., output_attentions=..., output_hidden_states=..., return_dict=..., training=...): # -> tuple[Any, tuple[()] | tuple[Any, ...] | None, tuple[Any, ...] | Any | tuple[()] | None, tuple[()] | tuple[Any, ...] | None, tuple[()] | tuple[Any, ...] | None] | TFBaseModelOutputWithPastAndCrossAttentions:
        r"""
        Args:
            input_ids (`tf.Tensor` of shape `(batch_size, sequence_length)`):
                Indices of input sequence tokens in the vocabulary. Padding will be ignored by default should you
...
class TFBlenderbotModel(TFBlenderbotPreTrainedModel):
    ...
    @classmethod
    def from_pretrained(cls, pretrained_model_name_or_path: Optional[Union[str, os.PathLike]], *model_args, **kwargs): # -> tuple[Any, dict[str, list[Any]]] | tuple[Any, dict[str, Any]] | tuple[TFBlenderbotSmallModel, dict[str, Any]] | TFBlenderbotSmallModel | tuple[Self, dict[str, Any]] | Self:
        ...
...
class TFBlenderbotForConditionalGeneration(TFBlenderbotPreTrainedModel, TFCausalLanguageModelingLoss):
    ...
    @classmethod
    def from_pretrained(cls, pretrained_model_name_or_path: Optional[Union[str, os.PathLike]], *model_args, **kwargs): # -> tuple[Any, dict[str, list[Any]]] | tuple[Any, dict[str, Any]] | tuple[TFBlenderbotSmallForConditionalGeneration, dict[str, Any]] | TFBlenderbotSmallForConditionalGeneration | tuple[Self, dict[str, Any]] | Self:
        ...
