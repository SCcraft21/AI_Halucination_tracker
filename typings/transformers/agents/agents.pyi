...
class CodeAgent(Agent):
    ...
    def run(self, task: str, return_generated_code: bool = ..., **kwargs): # -> _ConstantValue | list[Any] | Any | tuple[Any, ...] | Series[Any] | Callable[..., Any] | dict[Any, Any] | ndarray[Any, Any] | slice[Any, Any, Any] | set[Any]:
        """
