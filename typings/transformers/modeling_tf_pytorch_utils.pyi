...
def load_pytorch_checkpoint_in_tf2_model(tf_model, pytorch_checkpoint_path, tf_inputs=..., allow_missing_keys=..., output_loading_info=..., _prefix=..., tf_to_pt_weight_rename=...): # -> tuple[Any, dict[str, list[Any]]]:
    """Load pytorch checkpoints in a TF 2.0 model"""
    ...

def load_pytorch_model_in_tf2_model(tf_model, pt_model, tf_inputs=..., allow_missing_keys=...): # -> tuple[Any, dict[str, list[Any]]]:
    """Load pytorch checkpoints in a TF 2.0 model"""
    ...

def load_pytorch_weights_in_tf2_model(tf_model, pt_state_dict, tf_inputs=..., allow_missing_keys=..., output_loading_info=..., _prefix=..., tf_to_pt_weight_rename=...): # -> tuple[Any, dict[str, list[Any]]]:
    """Load pytorch state_dict in a TF 2.0 model."""
    ...

def load_pytorch_state_dict_in_tf2_model(tf_model, pt_state_dict, tf_inputs=..., allow_missing_keys=..., output_loading_info=..., _prefix=..., tf_to_pt_weight_rename=..., ignore_mismatched_sizes=..., skip_logger_warnings=...): # -> tuple[Any, dict[str, list[Any]]]:
